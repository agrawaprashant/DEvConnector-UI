...
class ZoomedImage extends React.Component {
    ...
    render() {
        ...
        return (
            <Modal orientation={this.state.orientation} modalClosed={this.props.closed} show>
                <div className={imageClasses.join(" ")}>
                    ...
                    <div className={classes.CloseBtn}><button onClick={() => this.props.closed()}> <i className="fas fa-times fa-lg"></i></button></div>
                </div>
            </Modal>
        );
    }
