...
export const GITHUB_SIGNUP_START = "GITHUB_SIGNUP_START";
export const GITHUB_SIGNUP_SUCCESS = "GITHUB_SIGNUP_SUCCESS";
export const GITHUB_SIGNUP_FAILED = "GITHUB_SIGNUP_FAILED";
...
export const GITHUB_SIGNUP_CANCELLED = "GITHUB_SIGNUP_CANCELLED";
...
export const CHANGE_PROFILE_PICTURE_START = "CHANGE_PROFILE_PICTURE_START";
...
export const CHAT_MESSAGE_SEEN_SENT = "CHAT_MESSAGE_SEEN_SENT";
export const CHAT_MESSAGE_SEEN_RECEIVED = "CHAT_MESSAGE_SEEN_RECEIVED";
export const NEW_CHAT_MESSAGE_RECEIVED = "NEW_CHAT_MESSAGE_RECEIVED";
export const NEW_CHAT_MESSAGE_SENT = "NEW_CHAT_MESSAGE_SENT";
export const FETCH_LAST_ACTIVE_START = "FETCH_LAST_ACTIVE_START";
export const FETCH_LAST_ACTIVE_SUCCESS = "FETCH_LAST_ACTIVE_SUCCESS";
export const FETCH_LAST_ACTIVE_FAILED = "FETCH_LAST_ACTIVE_FAILED";
...
export const UNFOLLOW_USER_SUCCESS = "FOUNLLOW_USER_SUCCESS";
export const UNFOLLOW_USER_FAILED = "UNFOLLOW_USEFAILEDRT";
